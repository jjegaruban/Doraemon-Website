              ...
              <div className="flex items-center justify-end">
                <div className="space-y-4">
                  <img
                    src={HeroImg2}
                    alt=""
                    className="w-full h-full object-cover rounded-xl shadow-md hover:scale-110 duration-200"
                  />
                  ...
                  Doraemon is a beloved Japanese manga and anime character, a robotic cat from the future who uses his futuristic gadgets to help a young boy named Nobita Nobi navigate life's challenges.
                  </p>
                </div>
              </div>
            </div>
